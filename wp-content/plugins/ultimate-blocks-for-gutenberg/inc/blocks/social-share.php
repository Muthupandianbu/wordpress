...
function egb_register_sharing() {
	...
	register_block_type(
		'easy-blocks/social-share', array(
			'style' => 'easy-blocks-style-css',
			'attributes' => array(
                'facebook' => array(
					'type'    => 'boolean',
					'default' => true,
				...
				'shareButtonStyle' => array(
					'type' => 'string',
					'default' => 'egb-share-icon-text',
				),
				'shareButtonShape' => array(
					'type' => 'string',
					'default' => 'egb-share-shape-circular',
				),
				'shareButtonEffect' => array(
					'type' => 'string',
					'default' => 'egb-social-rounded',
				),
				'shareButtonSize' => array(
					'type' => 'string',
					'default' => 'egb-share-size-medium',
				),
				'shareButtonColor' => array(
					'type' => 'string',
					'default' => 'egb-share-color-standard',
				),
			),
...
function egb_render_sharing( $attributes ) {
		...
		$share_url .= sprintf(
			'<li>
				<a
					...
					class="egb-share-twitter"
					title="%2$s">
					<i class="fab fa-twitter"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
			esc_url( $twitter_url ),
		...
		$share_url .= sprintf(
			'<li>
				<a
					href="javascript:void(0)"
					onClick="javascript:egbBlockShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"
					class="egb-share-facebook"
					title="%2$s">
					<i class="fab fa-facebook-f"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
		...
		$share_url .= sprintf(
			'<li>
				<a
					href="javascript:void(0)"
					onClick="javascript:egbBlockShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"
					class="egb-share-google"
					title="%2$s">
					<i class="fab fa-google"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
			esc_url( $google_url ),
		...
		$share_url .= sprintf(
			'<li>
				<a
					href="javascript:void(0)"
					onClick="javascript:egbBlockShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"
					class="egb-share-pinterest"
					title="%2$s">
					<i class="fab fa-pinterest-p"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
		...
		$share_url .= sprintf(
			'<li>
				<a
					href="javascript:void(0)"
					onClick="javascript:egbBlockShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"
					class="egb-share-linkedin"
					title="%2$s">
					<i class="fab fa-linkedin-in"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
		...
		$share_url .= sprintf(
			'<li>
				<a
					href="javascript:void(0)"
					onClick="javascript:egbBlockShare(\'%1$s\', \'%2$s\', \'600\', \'600\')"
					class="egb-share-reddit"
					title="%2$s">
					<i class="fab fa-reddit-alien"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
			esc_url( $reddit_url ),
	...
	if ( isset( $attributes['email'] ) && $attributes['email'] ) {
		$share_url .= sprintf(
			'<li>
				<a
					href="%1$s"
					class="egb-share-email"
					title="%2$s">
					<i class="fas fa-envelope"></i> <span class="egb-social-text">%2$s</span>
				</a>
			</li>',
			esc_url( $email_url ),
	...
	$block_content = sprintf(
		'<div class="wp-block-easy-blocks-egb-sharing egb-block-sharing %2$s %3$s %4$s %5$s %6$s">
			<ul class="egb-share-list">%1$s</ul>
		</div>',
		$share_url,
