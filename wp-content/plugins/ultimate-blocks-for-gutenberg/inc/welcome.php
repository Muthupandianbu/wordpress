		...
		<div class="intro_wrapper">
			...
			<header class="header">
				...
				<div class="about-text">
					<?php printf( __( "Ultimate and Easy Gutenberg Blocks Page Builder for WordPress.", UGB_TD ), UGB_VERSION ); ?>
				</div>
		...
		<div class="egb_contents">
				...
				<div class="wp-tab-panel" id="how-to">
					<h1 class="black textcenter main_heading">
						<?php _e( 'Welcome to Easy Blocks - Gutenberg Page Builder.', UGB_TD ); ?>
					</h1>				
					...
					<div class="parent">
								...
								<ul class="egb_demos">
									...
									<li>
										...
										<a 
											...
											target="_blank">
												<strong>
													<?php _e( 'Blog Post Grid/List', UGB_TD ); ?>
												</strong>
												<span class="ribbon trending">
													<?php _e( 'New', UGB_TD ); ?>
												</span>
						...
						<div class="right_column">
							<img class="tab-banner" src="<?php echo UGB_PLUGIN_URL .'/assets/images/banner-image.png';?>" alt="<?php echo UGB;?> Banner Image">
						</div>
					</div>
					...
					<div class="egb_features">
						<h2>
							<?php //_e( 'Easy Blocks - Gutenberg Blocks Page Builder', UGB_TD ); ?>
							<?php echo UGB;?>
						</h3>
						<p class="textcenter">
							<?php _e( 'Listed Blocks are available not on Easy Blocks - Gutenberg Blocks Page Builder Plugin. Blocks are being added daily ...', UGB_TD ); ?>
						</p>
				...
				<div class="wp-tab-panel" id="docs" style="display: none;">
					<div class="egb_features">
						<div class="egb_feature">
							...
							<p>
								<?php echo esc_html__('This is Documentation Section for Easy Blocks - Gutenberg Blocks Page Builder.', UGB_TD);?>
							</p>
							...
							<div class="parent">
								...
								<div class="left_column">
									<div class="left_block">
										...
										<h4>
											<?php echo esc_html__('Installation:', UGB_TD);?>
										</h4>
										...
										<h4>
											<?php echo esc_html__('Row and Columns Tutorial:', UGB_TD);?>
										</h4>
										<div class='embed-container'>
										...
										<h4>
											<?php echo esc_html__('Row and Columns Customizations Tutorial:', UGB_TD);?>
										</h4>
										<div class='embed-container'>
										...
										<div id="accordion">
											...
											<h3>
												<?php echo esc_html__('Can I use "Easy Blocks - Gutenberg Blocks Page Builder" Plugin without Gutenberg Plugin ?', UGB_TD);?>
											</h3>
											<div>
												<p>
													<?php echo esc_html__('Yes, if you have WordPress 5.0+ version installed then you can use Easy Blocks - Gutenberg Blocks Page Builder Plugin without "Gutenberg" Plugin.', UGB_TD);?>
												</p>
											</div>
											...
											<div>
												<p>
													<?php echo esc_html__('Basically, there\'s no Configuration required for using "Easy Blocks - Gutenberg Blocks Page Builder" Plugin.', UGB_TD);?>
												</p>
											</div>
											...
											<h3>
												<?php echo esc_html__('"Easy Blocks - Gutenberg Blocks Page Builder Plugin" Installed but Not Working !', UGB_TD);?>
											</h3>
											<div>
												<p>
													<?php echo esc_html__('First, deactive Other "Gutenberg Blocks" plugin and try again. In most cases, it\'ll be conflicting issue. Try Activate/Deactivate "Easy Blocks - Gutenberg Blocks Page Builder" Plugin. If nothing works then post on our Support Form(Link Mentioned above).', UGB_TD);?>
												</p>
											</div>
...
<a href="https://jeweltheme.com/order-service/" target="_blank">Order Service</a>
								...
								<div class="right_column">
									<img class="tab-banner" src="<?php echo UGB_PLUGIN_URL .'/assets/images/docs.png';?>" alt="Easy Blocks - Gutenberg Blocks Page Builder Block Banner Image">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="egb_features">
						<div class="egb_feature">
							...
							<div class="parent">
								...
								<div class="right_column">
									<img class="tab-banner" src="<?php echo UGB_PLUGIN_URL .'/assets/images/support.png';?>" alt="Easy Blocks - Gutenberg Blocks Page Builder Block Banner Image">
								</div>
							</div>
